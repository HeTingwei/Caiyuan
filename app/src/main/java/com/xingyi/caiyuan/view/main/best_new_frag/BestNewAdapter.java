...
public class BestNewAdapter extends RecyclerView.Adapter<BestNewAdapter.MyViewHolder> {
    ...
    public BestNewAdapter(List<NewItemBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        String path2= Environment.getExternalStorageDirectory().getPath()+"/smallFox.jpeg";
        for (int i = 0; i < 6; i++) {
           imgList.add(path);
        }
