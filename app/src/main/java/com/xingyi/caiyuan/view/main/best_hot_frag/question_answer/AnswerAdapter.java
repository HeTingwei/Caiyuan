package com.xingyi.caiyuan.view.main.best_hot_frag.question_answer;
...
import com.xingyi.caiyuan.view.common_activity.AnswerAndCommentActivity;
...
public class AnswerAdapter extends RecyclerView.Adapter<AnswerAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                context).inflate(R.layout.main_question_answer_item, parent,
                false));
        initHeaderView();
    ...
    private void initHeaderView() {
        ...
        //图片列表
        rvImg = (RecyclerView) mHeaderView.findViewById(R.id.img_recycler_view);
        rvImg.setLayoutManager(new GridLayoutManager(context, 3));
        rvImg.setAdapter(new ImageAdapter(imgList, context));
        ...
        spinnerList.add("按质量排序");
        spinnerList.add("按时间排序");

        adaperSpinner = new ArrayAdapter<>(context, R.layout.spinner_item, spinnerList);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //跳转问题回答评价界面
                    Intent intent=new Intent(context, AnswerAndCommentActivity.class);
                    context.startActivity(intent);
                }
            });
        }
