...
public class FollowTopicAdapter extends RecyclerView.Adapter<FollowTopicAdapter.MyViewHolder> {

    List<String> list;
    Context context;


    public FollowTopicAdapter(List<String> list, Context context) {
        this.list = list;
