...
public class EncyclopediasAdapter extends RecyclerView.Adapter<EncyclopediasAdapter.MyViewHolder> {
    ...
    public EncyclopediasAdapter(List<String> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                context).inflate(R.layout.find_encyclopedias_item, parent,
                false));
        return holder;
    }
