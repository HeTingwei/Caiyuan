package com.xingyi.caiyuan.view.find.expert;
...
public class ExpertActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.find_expert_layout);
        initData();
        initView();
    }
    ...
    private void initView() {
        recyclerView = (RecyclerView) findViewById(R.id.rv_expert);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(new ArticleAdapter(new ArrayList<String>(), this));
        recyclerView.setAdapter(new ExpertAdapter(list, this));
        ...
        searchBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ExpertActivity.this, editSearch.getText(), Toast.LENGTH_SHORT).show();
            }
        });

        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.expert_srl);
